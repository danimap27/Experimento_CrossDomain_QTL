...
class ExperimentRunner:
    def __init__(self, data_module, epochs=5, lr=0.05, model_kwargs=None):
    ...
    def _make_model(self, model_class, ansatz='A', n_layers=3):
        return model_class(ansatz=ansatz, n_layers=n_layers, **self.model_kwargs)
    ...
    def run_experiment_1(self, model_class, source_loader, task_a_loader, task_b_loader):
        ...
        baseline_model = self._make_model(model_class, ansatz='A', n_layers=3)
    ...
    def run_experiment_2(self, model_class, task_a_loader, task_b_loader):
        ...
        for ans in ['A', 'B', 'C']:
            ...
            model = self._make_model(model_class, ansatz=ans, n_layers=3)
    ...
    def run_experiment_3(self, model_class, source_loader, mob_source_loader, target_loader):
        ...
        source_model = self._make_model(model_class, ansatz='A', n_layers=3)
        ...
        mob_source_model = self._make_model(model_class, ansatz='A', n_layers=3)
        ...
        scratch_model = self._make_model(model_class, ansatz='A', n_layers=3)
        ...
        mob_qtl_model = self._make_model(model_class, ansatz='A', n_layers=3)
